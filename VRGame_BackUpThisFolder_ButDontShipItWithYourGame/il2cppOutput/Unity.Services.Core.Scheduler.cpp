...
IL_0031:
	{
		// lock (m_Lock)
		RuntimeObject* L_6 = __this->___m_Lock_2;
		V_2 = L_6;
		V_3 = (bool)0;
	}
	{
		...
		{// begin try (depth: 1)
			{
				...
				RuntimeObject* L_14 = __this->___m_TimeProvider_1;
				NullCheck(L_14);
				...
				int64_t L_19 = __this->___m_NextId_6;
				V_6 = L_19;
				int64_t L_20 = V_6;
				__this->___m_NextId_6 = ((int64_t)il2cpp_codegen_add(L_20, ((int64_t)1)));
				int64_t L_21 = V_6;
				NullCheck(L_18);
				L_18->___ActionId_2 = L_21;
				V_4 = L_18;
				// if (m_NextId < k_MinimumIdValue)
				int64_t L_22 = __this->___m_NextId_6;
...
IL_00a2_1:
			{
				...
				MinimumBinaryHeap_1_tB7A85B4D870F0107AF6031545D6054927A1CB7AD* L_24 = __this->___m_ScheduledActions_3;
				...
				Dictionary_2_t2306F810ADE46E708DBCF5BFFD57ED345A61D8CA* L_26 = __this->___m_IdScheduledInvocationMap_4;
...
IL_002c_1:
			{
				...
				MinimumBinaryHeap_1_tB7A85B4D870F0107AF6031545D6054927A1CB7AD* L_8 = __this->___m_ScheduledActions_3;
				...
				Dictionary_2_t2306F810ADE46E708DBCF5BFFD57ED345A61D8CA* L_10 = __this->___m_IdScheduledInvocationMap_4;
...
IL_00bb_1:
			...
			}
			{
				...
				List_1_tFD4080EF47ACD067F2E4AB57C9E2E8E64CA953E3* L_30 = __this->___m_ExpiredActions_5;
				NullCheck(L_30);
...
IL_00fc_2:
					{
						// foreach (var expiredAction in m_ExpiredActions)
						bool L_36;
						L_36 = Enumerator_MoveNext_m46C4F2A2917BB3C219137A08B6E29579FCBF6CA5((&V_7), Enumerator_MoveNext_m46C4F2A2917BB3C219137A08B6E29579FCBF6CA5_RuntimeMethod_var);
						if (L_36)
						{
							goto IL_00d2_2;
						}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ActionScheduler_JoinPlayerLoopSystem_mB998001E51285B4DF2406DE197A3A5377BD62892 (ActionScheduler_t25AE26866357EBC70F6698FCD3E0B6DBE7473154* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		PlayerLoopSystem_t8AED6BF1C8A309CAA6FF71AC91DD33BDDFF7CF1F L_9 = __this->___SchedulerLoopSystem_0;
		NullCheck(L_8);
